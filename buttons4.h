...
enum swtState {ON = 0, OFF};
enum swtNames {LEFT_SWT = 0, RIGHT_SWT};
// UP button
...
//Boosterpack switches
#define SWTPort         GPIO_PORTA_BASE
#define SWT1_PORT_BASE        GPIO_PORTA_BASE
#define SWT2_PORT_BASE        GPIO_PORTA_BASE
#define SWT1_PIN            GPIO_PIN_7
#define SWT2_PIN            GPIO_PIN_6
// Poll constants
#define NUM_BUT_POLLS 3
#define LONG_PRESS_POLLS 40 // Poll @100Hz -> 40 polls = 0.4s
...
// Not safe under interrupt, no debouncing implemented
//*******************************************************
uint8_t
checkSwitch(uint8_t swtName);
